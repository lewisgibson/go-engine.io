...
//
//	mockgen -package=engineio_test -destination=mock_transport_client_test.go -source=transport.go TransportClient
//

// Package engineio_test is a generated GoMock package.
...
func (m *MockTransport) SetURL(arg0 *url.URL) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetURL", arg0)
}

// SetURL indicates an expected call of SetURL.
func (mr *MockTransportMockRecorder) SetURL(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetURL", reflect.TypeOf((*MockTransport)(nil).SetURL), arg0)
}
